...
export default function IntroSection() {
  return (
    <section id="home" className="min-h-screen flex flex-col justify-center space-y-8 md:space-y-12 w-full items-center text-center px-4 py-20 md:py-0 text-white">
      ...
      <p className='max-w-2xl text-xl'>We leverage the latest technologies to built customised applications in real-time together with you.</p>
      ...
      <div className="flex flex-wrap gap-y-6 md:h-[100px] md:flex-nowrap md:items-end md:space-x-8 items-center justify-center md:mt-20">
