...
import '../Progressbar/ProgressbarMobile.css';
...
export default function ProgressbarNew() {
  ...
  return (
    <div className='space-y-4 flex flex-col items-center text-justify'>
      <div className='text-2xl font-bold'>Live Software Projects</div>
          <div className=''>
      ...
      <h2 className='text-2xl mt-8'>1. Vision Meeting </h2>
      ...
      <h2 className='text-2xl'>2. Live Coding Session </h2>
